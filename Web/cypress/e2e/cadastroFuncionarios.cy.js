...
describe('Seatecnologia - Cadastro', () => {
  ...
  it('CT-001 - Efetuar cadastro de funcionário com dados válidos', { tags: ['@smoke', '@regression'] }, () => {
  ...
  it('CT-002 - Efetuar cadastro de funcionário ativo com dados válidos', { tags: '@regression' }, () => {
    cy.get('.c-kUQtTK').click()
  ...
  it('CT-003 - Efetuar cadastro de funcionário com idade menor de 18 anos', { tags: '@know-issue' }, () => { 
    cy.get('.c-kUQtTK').click()
    cy.get('.ant-switch').click()
    cy.get('[name="name"]').type(employeeData.nome)
    cy.get('[name="cpf"]').type(employeeData.cpf)
  ...
  it('CT-004 - Efetuar cadastro de funcionário com data de nascimento futura', { tags: '@know-issue' }, () => { 
    cy.get('.c-kUQtTK').click()
    cy.get('.ant-switch').click()
    cy.get('[name="name"]').type(employeeData.nome)
    cy.get('[name="cpf"]').type(employeeData.cpf)
  ...
  it('CT-005 - Não permitir cadastro de funcionário com CPF duplicado', { tags: '@know issue' }, () => { 
    cy.get('.c-kUQtTK').click()
...
describe('Seatecnologia - Validação', () => {
  ...
  it('CT-006 - Validar preenchimento obrigatório do campo Nome', { tags: '@regression' }, () => {
  cy.get('.c-kUQtTK').click()  
  cy.get('[name="cpf"]').type(employeeData.cpf)
  cy.get('[name="rg"]').type(employeeData.rg)
  cy.get('input[name="birthDay"]').type(employeeData.dataNasc)
  ...
  it('CT-007 - Validar preenchimento obrigatório do campo CPF', { tags: '@regression' }, () => {
  cy.get('.c-kUQtTK').click()  
  cy.get('[name="name"]').type(employeeData.nome)
  cy.get('[name="rg"]').type(employeeData.rg)
  cy.get('input[name="birthDay"]').type(employeeData.dataNasc)
  ...
  it('CT-008 - Validar preenchimento obrigatório do campo RG', { tags: '@regression' }, () => {
  cy.get('.c-kUQtTK').click()  
  cy.get('[name="name"]').type(employeeData.nome)
  cy.get('[name="cpf"]').type(employeeData.cpf)
  cy.get('input[name="birthDay"]').type(employeeData.dataNasc)
  ...
  it('CT-009 - Validar preenchimento obrigatório do campo Data de nascimento', { tags: '@regression' } ,() => {
  cy.get('.c-kUQtTK').click()  
  cy.get('[name="name"]').type(employeeData.nome)
  cy.get('[name="cpf"]').type(employeeData.cpf)
  cy.get('[name="rg"]').type(employeeData.rg)
  ...
  it('CT-010 - Validar preenchimento obrigatório do campo Número do CA', { tags: '@regression' }, () => {
  cy.get('.c-kUQtTK').click()  
  cy.get('[name="name"]').type(employeeData.nome)
  cy.get('[name="cpf"]').type(employeeData.cpf)
  cy.get('[name="rg"]').type(employeeData.rg)
  ...
  it('CT-011 - Validar quantidade mínima de caracteres no campo CPF', { tags: '@regression' }, () => { // nao consegui validar a mensagem
  cy.get('.c-kUQtTK').click()  
  cy.get('[name="cpf"]').should('have.attr', 'minlength', '11')

  })

  it('CT-012 - Validar inserção de emojis nos campos de cadastro', { tags: '@know-issue' }, () => { 
    cy.get('.c-kUQtTK').click()
    cy.get('.ant-switch').click()
